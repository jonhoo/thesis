...
ax.axvline(0, color=common.colors['redis'])
ax.axvline(full['migration'][1] - full['migration'][0], ls='--', color=common.colors['full'])
ax.plot(partial['hitf']['time'], partial['hitf']['fraction'] * 100, 'o', color=common.colors['partial'], ms=2, alpha=0.5, label="Noria (partial)")
ax.plot(full['hitf']['time'], full['hitf']['fraction'] * 100, 'o', color=common.colors['full'], ms=2, alpha=0.5, label="Noria (full)")
ax.set_xlim(-5, 150)
ax.set_ylim(48, 102)
