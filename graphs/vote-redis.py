...
ax.plot(data["achieved"], data["p90"], '.-', color=common.colors['partial'], label="Noria, partial state")
...
ax.plot(data["achieved"], data["p90"], '.-', color=common.colors['redis'], label="Redis, 1 core")
