...
violate Invariant~\ref{i:no-holes}. However, this alone is not sufficient to
...
message includes data that will be included in B's eventual upquery response. If
it did, that data would be duplicated, which violates
Invariant~\ref{i:no-spurious}.
