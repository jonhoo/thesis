...
Invariant~\ref{i:prefix-consistency}.
...
Invariant~\ref{i:prefix-consistency}. For a right join, the same logic applies,
but mirrored to the right ancestor.
...
would remain perpetually stale, violating Invariant~\ref{i:prefix-consistency}.
